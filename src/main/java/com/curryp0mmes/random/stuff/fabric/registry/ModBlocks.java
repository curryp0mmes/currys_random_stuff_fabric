...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        Registry.register(Registry.BLOCK, new Identifier(RandomStuffMod.MOD_ID, "crystal_ore"), CRYSTAL_ORE);
        Registry.register(Registry.BLOCK, new Identifier(RandomStuffMod.MOD_ID, "crystal_block"), CRYSTAL_BLOCK);
        Registry.register(Registry.BLOCK, new Identifier(RandomStuffMod.MOD_ID, "crystal_bricks"), CRYSTAL_BRICKS);
    }
}
